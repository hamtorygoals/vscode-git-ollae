...
//
import Findings from '../Components/Survey/Findings';
import FindDetailPage from '../pages/Survey/FindDetailPage';
  ...
  return (
    <ReactRouters>
      <Route path="/" element={<Navbar />}>
        ...
        <Route path='survey' element={<Findings />} />
        <Route path='survey/:postId' element={<FindDetailPage />} />
      </Route>      
    </ReactRouters>
  );
};
